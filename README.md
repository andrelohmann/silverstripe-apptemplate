...
```json
{
	...
	"require": {
		...
		"composer/installers": "*",
                ...
                "andrelohmann-silverstripe-themes/bootstrap": "3.1.12.1",
                ...
                "andrelohmann-silverstripe/bootstrap_social_connect": "1.4",
                "andrelohmann-silverstripe/bootstrap_extra_fields": "1.11",
